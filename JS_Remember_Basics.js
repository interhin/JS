...
// или просто return false;
  ...
  // Например мы вешаем на родителя одно событие оно будет срабатывать и на дочерних эл-тах
  // И мы с помощью if сортируем эл-ты на которых будем обрабатывать события. Это и есть делегирование
